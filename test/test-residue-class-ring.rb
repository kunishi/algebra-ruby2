...
class TestResidueClassRing < Test::Unit::TestCase
  def test_residue_class_ring_01
    z13 = Algebra::ResidueClassRing.create(Integer, 13)
  ...
  def test_residue_class_ring_05
    ...
    h = Algebra::ResidueClassRing(g, y**5 + x * y + 1)
    y = h[y]
  ...
  def test_residue_class_ring_07
    ...
    z7 = Algebra::ResidueClassRing.create(Integer, 7)
    a = Algebra::Polynomial(z7, 'x')
    x = a.var
    b = Algebra::Polynomial(a, 'y')
    y = b.var
    c = Algebra::Polynomial(b, 'z')
    z = c.var
    d = Algebra::Polynomial(c, 'w')
    w = d.var
